package com.example.cryptoappk.data.database
...
interface CoinInfoDao {
    ...
    @Insert(onConflict = OnConflictStrategy.REPLACE)//каждый раз когда будут приходить новые данные, старые будет заменяться
